...
class DirectoryConfLoader(ConfLoader):
    ...
    def app_name_from_filename(self, fname):
        ...
        log.info('app_name_from_filename - fname1: %s path: %s fname2: %s app_name %s ext: %s', fname1, _path, fname, app_name, _ext)
        return app_name
    ...
    def filename_from_app_name(self, app_name):
        ...
        '/tmp/foobar.yaml'
        """
        log.info('filename_from_appname - base: %s appname: %s', self.base_dir, app_name)
